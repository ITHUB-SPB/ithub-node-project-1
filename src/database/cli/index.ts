...
export default function cli() {
    ...
    if (command === 'create') {
        try {
            ...
            spinner.fail(
                chalk.red(
                    `Ошибка при создании таблиц: ${(error as Error).message}`,
                ),
            );
        }
        ...
        try {
            ...
            spinner.fail(
                chalk.red(
                    `Ошибка при сбросе таблиц: ${(error as Error).message}`,
                ),
            );
        }
        ...
        try {
            ...
            spinner.fail(
                chalk.red(
                    `Ошибка при наполнении таблиц: ${(error as Error).message}`,
                ),
            );
        }
        ...
        try {
            ...
            spinner.fail(
                chalk.red(
                    `Ошибка при вызове help: ${(error as Error).message}`,
                ),
            );
        }
    } else {
